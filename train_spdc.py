...
def train_SPDC(model,
    ...
    with record_function("PRE TRAIN LOADING"):
        ...
        if 'crystal_z_weights' in config ['train']:
            ...
            crystal_z_weights = torch.tensor([0]+[1]*config['data']['nz']-1,dtype = torch.float3)
        ...
        for e in pbar:
            ...
            for x, y in train_loader:
                ...
                with record_function("LOSS CALCULATION"):
                    ...
                    total_loss = (ic_loss * ic_weight + f_loss * f_weight + data_loss * data_weight) * 1e12
                ...
                train_loss += (total_loss.item() / 1e12)
            scheduler.step()
